    ...
    return (
        <article id='study-india'
            ...
            <div className="images-gallery">
                ...
                <div className="hanger-card hanger-card-two" style={ { position: 'absolute', left: '1040px', top: '420px' } }>
                    <div style={ { transform: 'translate(5px,5px)' } }>
                        <img src={ image4 } alt="" />
                    </div>
                    <div style={ { margin: '10px 10px 20px 10px' } }>
