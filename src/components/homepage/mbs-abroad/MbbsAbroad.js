...
const MbbsAbroad = () => {
    ...
    return (
        <section id='mbbs-abroad' className='section'>
            <div className="images-slider-card">
                <div className="images-slider-cover">
                    ...
                    <div className="slider-image">
                        <div className={ slideImage === 2 ? 'slide-center-two' : '' }
                    ...
                    <div className="slider-image">
                        ...
                        >
                            <div style={ { position: slideImage === 1 ? 'relative' : '', right: '200%' } } >
                    ...
                    <div className=" dots">
                        <div onClick={ () => setSlideImage(1) } style={ { background: slideImage === 1 ? 'white' : '' } } ></div>
                        <div onClick={ () => setSlideImage(2) } style={ { background: slideImage === 2 ? 'white' : '' } } ></div>
                        <div onClick={ () => setSlideImage(3) } style={ { background: slideImage === 3 ? 'white' : '' } }></div>
                    </div>
                </div>
            </div>
            <div className="section-text">
                <h1 className='mb-4'>Study  MBBS Abroad</h1>
